              ...
              <div class="col-md-7">
                ...
                <div class="post-entry-sidebar">
                  <ul>
                    <li>
                      <a href="">
                        <img src="<?php echo base_url();?>assets/images/img_6.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                    ...
                    <li>
                      <a href="">
                        <img src="<?php echo base_url();?>assets/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                          <div class="post-meta">
                            <span class="mr-2">March 15, 2018 </span> &bullet;
                    ...
                    <li>
                      <a href="">
                        <img src="<?php echo base_url();?>assets/images/img_4.jpg" alt="Image placeholder" class="mr-4">
                        <div class="text">
                          <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                          <div class="post-meta">
                            <span class="mr-2">March 15, 2018 </span> &bullet;
