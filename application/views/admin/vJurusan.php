	...
	<div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Master Jurusan</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <table id="mytable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <th style="text-align: center;">
                    <a data-toggle="modal" data-target="#edit<?php echo $row->id_jurusan; ?>" class="btn btn-info btn-sm">
                      <span class="glyphicon glyphicon-pencil"></span> Edit 
                    </a>
                  </th>
                  <th style="text-align: center;">
                    <a data-toggle="modal" data-target="#delete<?php echo $row->id_jurusan; ?>"class="btn btn-danger btn-sm">
...
<div class="modal fade" id="add">
  ...
  <form class="form-horizontal" action="<?php echo site_url('admin/Jurusan/addJurusan');?>" method="post">
